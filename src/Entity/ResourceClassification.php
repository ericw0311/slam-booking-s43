...
/**
* @ORM\Table(uniqueConstraints={@ORM\UniqueConstraint(name="uk_resource_classification",columns={"file_id", "internal", "type", "name"})})
...
class ResourceClassification
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Resource", mappedBy="classification")
     */
    private $resources;
