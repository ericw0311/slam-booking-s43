 ...
 */
final class Version20191105213554 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE planification_view (id INT AUTO_INCREMENT NOT NULL, planification_period_id INT NOT NULL, user_file_group_id INT NOT NULL, user_id INT NOT NULL, active TINYINT(1) NOT NULL, oorder SMALLINT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, INDEX IDX_F68ECE39DCFAF5EA (planification_period_id), INDEX IDX_F68ECE39A18AFB8A (user_file_group_id), INDEX IDX_F68ECE39A76ED395 (user_id), UNIQUE INDEX uk_planification_view (planification_period_id, user_file_group_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE planification_view_resource ADD CONSTRAINT FK_640DF95112824F3E FOREIGN KEY (planification_view_id) REFERENCES planification_view (id)');
        ...
        $this->addSql('ALTER TABLE planification_view ADD CONSTRAINT FK_F68ECE39DCFAF5EA FOREIGN KEY (planification_period_id) REFERENCES planification_period (id)');
        $this->addSql('ALTER TABLE planification_view ADD CONSTRAINT FK_F68ECE39A18AFB8A FOREIGN KEY (user_file_group_id) REFERENCES user_file_group (id)');
        $this->addSql('ALTER TABLE planification_view ADD CONSTRAINT FK_F68ECE39A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE planification_view DROP FOREIGN KEY FK_F68ECE39DCFAF5EA');
        ...
        $this->addSql('ALTER TABLE planification_view DROP FOREIGN KEY FK_F68ECE39A76ED395');
        ...
        $this->addSql('ALTER TABLE planification_view_resource DROP FOREIGN KEY FK_640DF95112824F3E');
        $this->addSql('ALTER TABLE planification_view DROP FOREIGN KEY FK_F68ECE39A18AFB8A');
        ...
        $this->addSql('DROP TABLE planification_view');
